...
This extension uses the cryptographic primitives defined in the [Message Signatures](https://sakinaroufid.github.io/ucp-announcement/draft/specification/signatures/index.md) specification:
...
- **Key Discovery:** `signing_keys[]` in `/.well-known/ucp` (see [Key Discovery](https://sakinaroufid.github.io/ucp-announcement/draft/specification/overview/#key-discovery))

See [Message Signatures](https://sakinaroufid.github.io/ucp-announcement/draft/specification/signatures/index.md) for complete details on algorithms, key format, and key rotation.

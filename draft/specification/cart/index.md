...
The Cart capability enables basket building without the complexity of checkout. While [Checkout](https://sakinaroufid.github.io/ucp-announcement/draft/specification/checkout/index.md) manages payment handlers, status lifecycle, and order finalization, cart provides a lightweight CRUD interface for item collection before purchase intent is established.
...
| line_items   | Array\[[Line Item Response](/ucp-announcement/draft/specification/reference/#line-item)\] | **Yes**  | Cart line items. Same structure as checkout. Full replacement on update.                                                                                                                                                                                                                                                                                                                                |
...
- [REST Binding](https://sakinaroufid.github.io/ucp-announcement/draft/specification/cart-rest/#create-cart)
- [MCP Binding](https://sakinaroufid.github.io/ucp-announcement/draft/specification/cart-mcp/#create_cart)

### Get Cart

Retrieves the latest state of a cart session. Returns `not_found` if the cart does not exist, has expired, or was canceled.

- [REST Binding](https://sakinaroufid.github.io/ucp-announcement/draft/specification/cart-rest/#get-cart)
- [MCP Binding](https://sakinaroufid.github.io/ucp-announcement/draft/specification/cart-mcp/#get_cart)
...
- [REST Binding](https://sakinaroufid.github.io/ucp-announcement/draft/specification/cart-rest/#update-cart)
- [MCP Binding](https://sakinaroufid.github.io/ucp-announcement/draft/specification/cart-mcp/#update_cart)
...
- [REST Binding](https://sakinaroufid.github.io/ucp-announcement/draft/specification/cart-rest/#cancel-cart)
- [MCP Binding](https://sakinaroufid.github.io/ucp-announcement/draft/specification/cart-mcp/#cancel_cart)

## Entities

Cart reuses the same entity schemas as [Checkout](https://sakinaroufid.github.io/ucp-announcement/draft/specification/checkout/index.md). This ensures consistent data structures when converting a cart to a checkout session.
...
The same totals contract applies to cart and checkout. See [Checkout Totals](https://sakinaroufid.github.io/ucp-announcement/draft/specification/checkout/#totals) for the rendering contract, accounting identity, well-known types, repeating types, and sub-line semantics.

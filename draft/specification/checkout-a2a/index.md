...
This document specifies the Agent2Agent Protocol (A2A) binding for [Checkout Capability](https://sakinaroufid.github.io/ucp-announcement/draft/specification/checkout/index.md).
...
The URI for UCP A2A extension: `https://ucp.dev/draft/specification/reference`

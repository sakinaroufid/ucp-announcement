...
See [REST](https://sakinaroufid.github.io/ucp-announcement/draft/specification/checkout-rest/#create-checkout) and [MCP](https://sakinaroufid.github.io/ucp-announcement/draft/specification/checkout-mcp/#create_checkout) binding examples.
...
> **Note:** Checkout permalinks are a REST-specific construct that extends the [REST transport binding](https://sakinaroufid.github.io/ucp-announcement/draft/specification/checkout-rest/index.md). Accessing a permalink returns a redirect to the checkout UI or renders the checkout page directly.
...
Scope declaration, derivation, and rules for extending this set with custom scopes are defined in [Identity Linking — Scopes](https://sakinaroufid.github.io/ucp-announcement/draft/specification/identity-linking/#scopes).
...
| line_items   | Array\[[Line Item Response](/ucp-announcement/draft/specification/reference/#line-item)\] | **Yes**  | List of line items being checked out.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| payment      | [Payment](/ucp-announcement/draft/specification/checkout/#payment)                        | No       | Payment configuration containing handlers.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
When the [Cart](https://sakinaroufid.github.io/ucp-announcement/draft/specification/cart/index.md) capability is negotiated, the request payload should accept an additional `cart_id` field for cart-to-checkout conversion. See [Cart → Cart-to-Checkout Conversion](https://sakinaroufid.github.io/ucp-announcement/draft/specification/cart/#cart-to-checkout-conversion) for the field contract.
...
This object MUST be one of the following types: [Checkout](/ucp-announcement/draft/specification/checkout/#checkout), [Error Response](/ucp-announcement/draft/specification/reference/#error-response).
...
| signals     | [Signals](/ucp-announcement/draft/specification/reference/#signals)         | No       | Environment data provided by the platform to support authorization and abuse prevention. Values MUST NOT be buyer-asserted claims — platforms provide signals based on direct observation or independently verifiable third-party attestations. All signal keys MUST use reverse-domain naming to ensure provenance and prevent collisions when multiple extensions contribute to the shared namespace. |
| attribution | [Attribution](/ucp-announcement/draft/specification/reference/#attribution) | No       | Platform-emitted referral and conversion-event context — campaign identifiers, click IDs, source/medium markers, etc. The same parameters platforms communicate via URL query parameters in browser-based flows.                                                                                                                                                                                        |
| payment     | [Payment](/ucp-announcement/draft/specification/checkout/#payment)          | **Yes**  | Payment configuration containing handlers.                                                                                                                                                                                                                                                                                                                                                              |
...
- [REST Binding](https://sakinaroufid.github.io/ucp-announcement/draft/specification/checkout-rest/index.md): RESTful API mapping using standard HTTP verbs and JSON payloads.
- [MCP Binding](https://sakinaroufid.github.io/ucp-announcement/draft/specification/checkout-mcp/index.md): Model Context Protocol mapping for agentic interaction.
- [A2A Binding](https://sakinaroufid.github.io/ucp-announcement/draft/specification/checkout-a2a/index.md): Agent-to-Agent Protocol mapping for agentic interactions.
- [Embedded Checkout Binding](https://sakinaroufid.github.io/ucp-announcement/draft/specification/embedded-checkout/index.md): JSON-RPC for powering embedded checkout.
...
Environment data provided by the platform to support authorization and abuse prevention. Unlike `context` (buyer-asserted preferences) and `buyer` (self-reported identity), signal values MUST NOT be buyer-asserted claims — platforms provide signals based on direct observation or by relaying independently verifiable third-party attestations. See [Signals](https://sakinaroufid.github.io/ucp-announcement/draft/specification/overview/#signals) for details and privacy requirements.
...
Platform-provided referral and conversion-event context — campaign IDs, click identifiers, and source/medium markers communicated by the platform. See [Attribution](https://sakinaroufid.github.io/ucp-announcement/draft/specification/overview/#attribution) for details and consent requirements.

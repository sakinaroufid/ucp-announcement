...
The only supported instrument schema is [CardPaymentInstrument](/ucp-announcement/draft/schemas/shopping/types/card_payment_instrument.json), the only supported checkout credential schema is `EncryptedCredential`, and the only supported source credential schema is [CardCredential](/ucp-announcement/draft/schemas/shopping/types/card_credential.json).
...
- **Instrument Schema:** [schemas/shopping/types/card_payment_instrument.json](/ucp-announcement/draft/schemas/shopping/types/card_payment_instrument.json)

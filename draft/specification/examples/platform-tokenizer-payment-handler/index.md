...
The handler accepts [CardCredential](/ucp-announcement/draft/schemas/shopping/types/card_credential.json) for tokenization and produces [TokenCredential](/ucp-announcement/draft/schemas/shopping/types/token_credential.json) for checkout.
...
- **Pattern:** [Tokenization Payment Handler](https://sakinaroufid.github.io/ucp-announcement/draft/specification/payment-handler-guide/index.md)
- **API Pattern:** [handlers/tokenization/openapi.json](/ucp-announcement/draft/handlers/tokenization/openapi.json)

...
This document specifies the Model Context Protocol (MCP) binding for the [Order Capability](https://sakinaroufid.github.io/ucp-announcement/draft/specification/order/index.md).
...
| ----------- | ------------------------------------------------------------------------------------------------- | ---------------------------------- |
| `get_order` | [Get Order](https://sakinaroufid.github.io/ucp-announcement/draft/specification/order/#get-order) | Get the current state of an order. |

### `get_order`

Maps to the [Get Order](https://sakinaroufid.github.io/ucp-announcement/draft/specification/order/#get-order) operation. Returns the current-state snapshot of an order.

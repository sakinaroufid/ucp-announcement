...
The handler schema defines three config variants for different contexts. See [Payment Handler Guide: Defining the Schema](https://sakinaroufid.github.io/ucp-announcement/draft/specification/payment-handler-guide/#defining-the-schema) for the full pattern.

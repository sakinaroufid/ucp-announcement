...
| line_items   | Array\[[Line Item](/ucp-announcement/draft/specification/reference/#line-item)\] | **Yes**  | Cart line items. Same structure as checkout. Full replacement on update.                                                                                                                                                                                                                                                                                                                                |
| context      | [Context](/ucp-announcement/draft/specification/reference/#context)              | No       | Buyer signals for localization (country, region, postal_code). Merchant uses for pricing, availability, currency. Falls back to geo-IP if omitted.                                                                                                                                                                                                                                                      |
| signals      | [Signals](/ucp-announcement/draft/specification/reference/#signals)              | No       | Environment data provided by the platform to support authorization and abuse prevention. Values MUST NOT be buyer-asserted claims — platforms provide signals based on direct observation or independently verifiable third-party attestations. All signal keys MUST use reverse-domain naming to ensure provenance and prevent collisions when multiple extensions contribute to the shared namespace. |
| attribution  | [Attribution](/ucp-announcement/draft/specification/reference/#attribution)      | No       | Platform-emitted referral and conversion-event context — campaign identifiers, click IDs, source/medium markers, etc. The same parameters platforms communicate via URL query parameters in browser-based flows.                                                                                                                                                                                        |
| buyer        | [Buyer](/ucp-announcement/draft/specification/reference/#buyer)                  | No       | Optional buyer information for personalized estimates.                                                                                                                                                                                                                                                                                                                                                  |
| currency     | string                                                                           | **Yes**  | ISO 4217 currency code. Determined by merchant based on context or geo-IP.                                                                                                                                                                                                                                                                                                                              |
| totals       | [Totals](/ucp-announcement/draft/specification/reference/#totals)                | **Yes**  | Estimated cost breakdown. May be partial if shipping/tax not yet calculable.                                                                                                                                                                                                                                                                                                                            |
| messages     | Array\[[Message](/ucp-announcement/draft/specification/reference/#message)\]     | No       | Validation messages, warnings, or informational notices.                                                                                                                                                                                                                                                                                                                                                |
| links        | Array\[[Link](/ucp-announcement/draft/specification/reference/#link)\]           | No       | Optional merchant links (policies, FAQs).                                                                                                                                                                                                                                                                                                                                                               |
...
| line_items   | Array\[[Line Item](/ucp-announcement/draft/specification/reference/#line-item)\]          | **Yes**  | List of line items being checked out.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| buyer        | [Buyer](/ucp-announcement/draft/specification/reference/#buyer)                           | No       | Representation of the buyer.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
| context      | [Context](/ucp-announcement/draft/specification/reference/#context)                       | No       | Provisional buyer signals for relevance and localization—not authoritative data. Businesses SHOULD use these values when verified inputs (e.g., shipping address) are absent, and MAY ignore or down-rank them if inconsistent with higher-confidence signals (authenticated account, risk detection) or regulatory constraints (export controls). Eligibility and policy enforcement MUST occur at checkout time using binding transaction data. Context SHOULD be non-identifying and can be disclosed progressively—coarse signals early, finer resolution as the session progresses. Higher-resolution data (shipping address, billing address) supersedes context. |
| signals      | [Signals](/ucp-announcement/draft/specification/reference/#signals)                       | No       | Environment data provided by the platform to support authorization and abuse prevention. Values MUST NOT be buyer-asserted claims — platforms provide signals based on direct observation or independently verifiable third-party attestations. All signal keys MUST use reverse-domain naming to ensure provenance and prevent collisions when multiple extensions contribute to the shared namespace.                                                                                                                                                                                                                                                                 |
| attribution  | [Attribution](/ucp-announcement/draft/specification/reference/#attribution)               | No       | Platform-emitted referral and conversion-event context — campaign identifiers, click IDs, source/medium markers, etc. The same parameters platforms communicate via URL query parameters in browser-based flows.                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| totals       | [Totals](/ucp-announcement/draft/specification/reference/#totals)                         | **Yes**  | Different cart totals.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| messages     | Array\[[Message](/ucp-announcement/draft/specification/reference/#message)\]              | No       | List of messages with error and info about the checkout session state.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  |
| links        | Array\[[Link](/ucp-announcement/draft/specification/reference/#link)\]                    | **Yes**  | Links to be displayed by the platform (Privacy Policy, TOS). Mandatory for legal compliance.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            |
...
| payment      | [Payment](/ucp-announcement/draft/specification/reference/#payment)                       | No       | Payment configuration containing handlers.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
| order        | [Order Confirmation](/ucp-announcement/draft/specification/reference/#order-confirmation) | No       | Details about an order created for this checkout session.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
...
| line_items    | Array\[[Order Line Item](/ucp-announcement/draft/specification/reference/#order-line-item)\] | **Yes**  | Line items representing what was purchased — can change post-order via edits or exchanges.                                                    |
| fulfillment   | object                                                                                       | **Yes**  | Fulfillment data: buyer expectations and what actually happened.                                                                              |
| adjustments   | Array\[[Adjustment](/ucp-announcement/draft/specification/reference/#adjustment)\]           | No       | Post-order events (refunds, returns, credits, disputes, cancellations, etc.) that exist independently of fulfillment.                         |
| currency      | string                                                                                       | **Yes**  | ISO 4217 currency code. MUST match the currency from the originating checkout session.                                                        |
| totals        | [Totals](/ucp-announcement/draft/specification/reference/#totals)                            | **Yes**  | Different totals for the order.                                                                                                               |
| messages      | Array\[[Message](/ucp-announcement/draft/specification/reference/#message)\]                 | No       | Business outcome messages (errors, warnings, informational). Present when the business needs to communicate status or issues to the platform. |
| attribution   | [Attribution](/ucp-announcement/draft/specification/reference/#attribution)                  | No       | Snapshot of the attribution associated with the originating checkout. Read-only on the order.                                                 |
...
| messages     | Array\[[Message](/ucp-announcement/draft/specification/reference/#message)\] | **Yes**  | Array of messages describing why the operation failed.            |
...
This object MUST be one of the following types: [Message Error](/ucp-announcement/draft/specification/reference/#message-error), [Message Warning](/ucp-announcement/draft/specification/reference/#message-warning), [Message Info](/ucp-announcement/draft/specification/reference/#message-info).
...
| code         | [Error Code](/ucp-announcement/draft/specification/reference/#error-code) | **Yes**  | Error code identifying the type of error. Standard errors are defined in capability specifications (see examples) and have standardized semantics; freeform codes are permitted.                                                                                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| code         | [Info Code](/ucp-announcement/draft/specification/reference/#info-code) | No       | Info code identifying the type of informational message. Standard codes are defined in capability specifications (see examples) and have standardized semantics; freeform codes are permitted. |
| content_type | string                                                                  | No       | Content format, default = plain. **Enum:** `plain`, `markdown`                                                                                                                                 |
| content      | string                                                                  | **Yes**  | Human-readable message.                                                                                                                                                                        |
...
| code         | [Warning Code](/ucp-announcement/draft/specification/reference/#warning-code) | **Yes**  | Warning code identifying the type of warning. Standard codes are defined in capability specifications (see examples) and have standardized semantics; freeform codes are permitted.                                                                 |
...
| Name     | Type                                                              | Required | Description                                           |
| -------- | ----------------------------------------------------------------- | -------- | ----------------------------------------------------- |
| amount   | [Amount](/ucp-announcement/draft/specification/reference/#amount) | **Yes**  | Amount in ISO 4217 minor units. Use 0 for free items. |
...
| totals      | Array\[[Total](/ucp-announcement/draft/specification/reference/#total)\] | No       | Adjustment totals breakdown. Signed values - negative for money returned to buyer (refunds, credits), positive for additional charges (exchanges).                                              |
...
| identity    | [Payment Identity](/ucp-announcement/draft/specification/reference/#payment-identity) | No       | The participant this token is bound to. Required when acting on behalf of another participant (e.g., agent tokenizing for merchant). Omit when the authenticated caller is the binding target. |
...
| billing_address | [Postal Address](/ucp-announcement/draft/specification/reference/#postal-address)         | No       | The billing address associated with this payment method.                                                                                                     |
| credential      | [Payment Credential](/ucp-announcement/draft/specification/reference/#payment-credential) | No       | The base definition for any payment credential. Handlers define specific credential types.                                                                   |
...
| destination    | [Postal Address](/ucp-announcement/draft/specification/reference/#postal-address) | **Yes**  | Delivery destination address.                                                                               |
...
| Name              | Type                                                                                                                   | Required | Description                         |
| ----------------- | ---------------------------------------------------------------------------------------------------------------------- | -------- | ----------------------------------- |
| methods           | Array\[[Fulfillment Method](/ucp-announcement/draft/specification/reference/#fulfillment-method)\]                     | No       | Fulfillment methods for cart items. |
| available_methods | Array\[[Fulfillment Available Method](/ucp-announcement/draft/specification/reference/#fulfillment-available-method)\] | No       | Inventory availability hints.       |
...
This object MUST be one of the following types: [Shipping Destination](/ucp-announcement/draft/specification/reference/#shipping-destination), [Retail Location](/ucp-announcement/draft/specification/reference/#retail-location).
...
| options            | Array\[[Fulfillment Option](/ucp-announcement/draft/specification/reference/#fulfillment-option)\] | No       | Available fulfillment options for this group.                          |
...
| destinations            | Array\[[Fulfillment Destination](/ucp-announcement/draft/specification/reference/#fulfillment-destination)\] | No       | Available destinations. For shipping: addresses. For pickup: retail locations.                               |
| selected_destination_id | ['string', 'null']                                                                                           | No       | ID of the selected destination.                                                                              |
| groups                  | Array\[[Fulfillment Group](/ucp-announcement/draft/specification/reference/#fulfillment-group)\]             | No       | Fulfillment groups for selecting options. Agent sets selected_option_id on groups to choose shipping method. |
...
| totals                    | Array\[[Total](/ucp-announcement/draft/specification/reference/#total)\] | **Yes**  | Fulfillment option totals breakdown.                                       |
...
| price     | [Amount](/ucp-announcement/draft/specification/reference/#amount) | **Yes**  | Unit price in ISO 4217 minor units.                                                                                                                                         |
...
| --------- | ------------------------------------------------------------------------ | -------- | ------------------------------------------------------ |
| id        | string                                                                   | **Yes**  |                                                        |
| item      | [Item](/ucp-announcement/draft/specification/reference/#item)            | **Yes**  |                                                        |
| quantity  | integer                                                                  | **Yes**  | Quantity of the item being purchased.                  |
| totals    | Array\[[Total](/ucp-announcement/draft/specification/reference/#total)\] | **Yes**  | Line item totals breakdown.                            |
...
| item      | [Item](/ucp-announcement/draft/specification/reference/#item)            | **Yes**  | Product data (id, title, price, image_url).                                                                                                                                                                                                                         |
...
| Name | Type                                                              | Required | Description                            |
| ---- | ----------------------------------------------------------------- | -------- | -------------------------------------- |
| min  | [Amount](/ucp-announcement/draft/specification/reference/#amount) | No       | Minimum price in ISO 4217 minor units. |
| max  | [Amount](/ucp-announcement/draft/specification/reference/#amount) | No       | Maximum price in ISO 4217 minor units. |
...
| Name | Type                                                            | Required | Description                 |
| ---- | --------------------------------------------------------------- | -------- | --------------------------- |
| min  | [Price](/ucp-announcement/draft/specification/reference/#price) | **Yes**  | Minimum price in the range. |
| max  | [Price](/ucp-announcement/draft/specification/reference/#price) | **Yes**  | Maximum price in the range. |
...
| title            | string                                                                                     | **Yes**  | Product title.                                                                                   |
| description      | [Description](/ucp-announcement/draft/specification/reference/#description)                | **Yes**  | Product description in one or more formats.                                                      |
| url              | string                                                                                     | No       | Canonical product page URL.                                                                      |
| categories       | Array\[[Category](/ucp-announcement/draft/specification/reference/#category)\]             | No       | Product categories with optional taxonomy identifiers.                                           |
| price_range      | [Price Range](/ucp-announcement/draft/specification/reference/#price-range)                | **Yes**  | Price range across all variants.                                                                 |
| list_price_range | [Price Range](/ucp-announcement/draft/specification/reference/#price-range)                | No       | List price range before discounts (for strikethrough display).                                   |
| media            | Array\[[Media](/ucp-announcement/draft/specification/reference/#media)\]                   | No       | Product media (images, videos, 3D models). First item is the featured media for listings.        |
| options          | Array\[[Product Option](/ucp-announcement/draft/specification/reference/#product-option)\] | No       | Product options (Size, Color, etc.).                                                             |
| variants         | Array\[[Variant](/ucp-announcement/draft/specification/reference/#variant)\]               | **Yes**  | Purchasable variants of this product. First item is the featured variant for listings.           |
| rating           | [Rating](/ucp-announcement/draft/specification/reference/#rating)                          | No       | Aggregate product rating.                                                                        |
...
| values | Array\[[Option Value](/ucp-announcement/draft/specification/reference/#option-value)\] | **Yes**  | Available values for this option.    |
...
| address | [Postal Address](/ucp-announcement/draft/specification/reference/#postal-address) | No       | Physical address of the location. |
...
| amount       | [Signed Amount](/ucp-announcement/draft/specification/reference/#signed-amount) | **Yes**  | Monetary amount in the currency's minor unit as defined by ISO 4217. Refer to the currency's exponent to determine minor-to-major ratio (e.g., 2 for USD, 0 for JPY, 3 for KWD). May be negative — the sign is intrinsic to the value (e.g., discounts are negative, charges are positive). |
...
| description  | [Description](/ucp-announcement/draft/specification/reference/#description)                  | **Yes**  | Variant description in one or more formats.                                               |
| url          | string                                                                                       | No       | Canonical variant page URL.                                                               |
| categories   | Array\[[Category](/ucp-announcement/draft/specification/reference/#category)\]               | No       | Variant categories with optional taxonomy identifiers.                                    |
| price        | [Price](/ucp-announcement/draft/specification/reference/#price)                              | **Yes**  | Current selling price.                                                                    |
| list_price   | [Price](/ucp-announcement/draft/specification/reference/#price)                              | No       | List price before discounts (for strikethrough display).                                  |
...
| options      | Array\[[Selected Option](/ucp-announcement/draft/specification/reference/#selected-option)\] | No       | Option values that define this variant (e.g., Color: Blue, Size: Large).                  |
| media        | Array\[[Media](/ucp-announcement/draft/specification/reference/#media)\]                     | No       | Variant media (images, videos, 3D models). First item is the featured media for listings. |
| rating       | [Rating](/ucp-announcement/draft/specification/reference/#rating)                            | No       | Variant rating.                                                                           |
...
| services         | object | **Yes**  | Service registry keyed by reverse-domain name.                              |
